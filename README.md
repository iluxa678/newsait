...
По представленным диаграммам были разработанны следующие классы (рисунок 4): 
...
Так же по представленным диаграммам были разработанны хранилища, которые позволяют создавать, хранить, актуализировать и использовать информацию в системе (рисунок 5):
...
Так же по представленным диаграммам были разработанны контроллеры, применяемые для взаимодействия с клиентом (рисунок 6): 
...
После выполнения операции сервер выдаёт новую информацию о том же авторе (рисунок 14).
<p align="center">
...
Функцией Read проверим вышеуказанную операцию. После срабатывания сервер выдает новую информацию(рисунок 15).
<p align="center">
...
4) Delete - используется для удаления записи по идентификатору. Если операция удаления сработает успешно, то ответ сервера будет "true", иначе "false" (рисунок 16).
<p align="center">
...
После выполнения операции ответ сервера (рисунок 17)
<p align="center">
