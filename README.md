...
<Последняя разработанная диаграмма - это диаграмма отношений. В результате анализа предметной области были выявлены следующие сущности: вид, порода, и пол животного, клиент, животное, обращение, заключение, доктор, должность и услуга доктора, симптоматика заболевания, заболевание, симптомы, рекомендации, метод лечения, и диагноз.
