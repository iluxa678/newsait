...
![DFD Diagramm](https://user-images.githubusercontent.com/91088733/144329861-843546dc-824c-4615-ab51-c91806498e8b.png)
...
Последняя разработанная диаграмма - это диаграмма отношений(в результате анализа были выявлены следующие сущности(и их поля): было определено, чтов предметной области определена сущность клиент, сущность клиент характеризуется такими атрибутами как:фамилия)
